...
export class Backend implements backendInterface {
    ...
    async addLicense(arg0: string, arg1: string, arg2: string, arg3: string): Promise<LicenseId> {
        if (this.processError) {
            try {
                const result = await this.actor.addLicense(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteLicense(arg0: LicenseId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteLicense(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllLicenses(): Promise<Array<License>> {
        if (this.processError) {
            try {
    ...
    async getLicense(arg0: LicenseId): Promise<License> {
        if (this.processError) {
            try {
                const result = await this.actor.getLicense(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLicenses(): Promise<Array<License>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLicenses();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLicense(arg0: LicenseId, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLicense(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
